...
const Navbar = () => {
  return (
    <div className='container'>       
             ...
             <button className='but'>GET STARTED</button><p>Fully Functional 30 days trial</p>
             ...
             <div className='Divs'>
             <div className='Man'> Project Management</div>
             <div className='Man'>Time Management</div>
             <div className='Man'>Billing and invoicing</div>
             <div className='Man'>Reporting</div>
             <div className='Man'>Time Off</div>
             </div>
